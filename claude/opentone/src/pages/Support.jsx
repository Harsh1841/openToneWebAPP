    ...
    <main className={styles.wrap}>
      ...
      <section className={styles.section}>
        ...
        {[
          ...
          { q: '7. How do I delete my account and data?', a: null, extra: <p className={styles.p}>You can request account and data deletion by emailing <a href="mailto:support@opentoneapp.com" className={styles.link}>support@opentoneapp.com</a>. Since all voice processing is on-device, deleting the app also removes all locally stored session data immediately.</p> },
        ].map(({ q, a, extra }) => (
      ...
      <section className={styles.section}>
        ...
        <p className={styles.p}><strong>Email:</strong> <a href="mailto:support@opentoneapp.com" className={styles.link}>support@opentoneapp.com</a></p>
        <p className={styles.p}><strong>Privacy Inquiries:</strong> <a href="mailto:privacy@opentoneapp.com" className={styles.link}>privacy@opentoneapp.com</a></p>
